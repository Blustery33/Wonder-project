...
class Question
{
    ...
    #[Assert\Length(min: 10, minMessage: 'Veuillez détailler un peu plus votre titre', max: 255, maxMessage: 'Le titre de votre question est trop long')]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: 'Veuillez détailler votre question')]
    #[Assert\Length(min: 100, minMessage: 'Veuillez détailler un peu plus votre question')]
